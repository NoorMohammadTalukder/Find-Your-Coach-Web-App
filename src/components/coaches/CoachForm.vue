<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{invalid: !rate.isValid}">
      ...
      <p v-if="!rate.isValid">*Rate Name must not be empty</p>
    </div>
    ...
    <div class="form-control" :class="{invalid: !areas.isValid}">
      ...
      <div>
        ...
        />
        <label for="fontend">Frontend Developement</label>
      </div>
      ...
      <p v-if="!areas.isValid">*Area Name must not be empty</p>
    </div>
    <p v-if="!formIsValid">*Fix the above error and submit again...</p>
